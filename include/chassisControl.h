...
public:
  void Up()
  {
    LeftOn.spin(vex::directionType::fwd,13000,vex::voltageUnits::mV);
    RightOn.spin(vex::directionType::fwd,13000,vex::voltageUnits::mV);
  }
  void Down()
  {
    LeftOn.spin(vex::directionType::fwd,-13000,vex::voltageUnits::mV);
  ...
  void Stopupdown(){
   LeftOn.stop(vex::brakeType::coast);
   RightOn.stop(vex::brakeType::coast);
  }
  void In()
  {
    LeftHand.spin(vex::directionType::fwd,13000,vex::voltageUnits::mV);
    RightHand.spin(vex::directionType::fwd,13000,vex::voltageUnits::mV);
  }
  void Out()
  {
    LeftHand.spin(vex::directionType::fwd,-13000,vex::voltageUnits::mV);
  ...
  void StopInOut(){
   LeftHand.stop(vex::brakeType::coast);
   RightHand.stop(vex::brakeType::coast);
  }
  ...
  double LeftRotation(){
    return (LeftWheel1.rotation(vex::rotationUnits::deg)+LeftWheel2.rotation(vex::rotationUnits::deg))/2;
            //LeftWheel3.rotation(vex::rotationUnits::deg)+LeftWheel4.rotation(vex::rotationUnits::deg))/4;//TODO:乘传动比!!
  }
  double RightRotation(){
    return (RightWheel1.rotation(vex::rotationUnits::deg)+RightWheel2.rotation(vex::rotationUnits::deg))/2;
            //RightWheel3.rotation(vex::rotationUnits::deg)+RightWheel4.rotation(vex::rotationUnits::deg))/4; 
  }
  //returns in pct
  double LeftVelocity(){
    return (LeftWheel1.velocity(vex::percentUnits::pct)+LeftWheel2.velocity(vex::percentUnits::pct))/2;
            //LeftWheel3.velocity(vex::percentUnits::pct)+LeftWheel4.velocity(vex::percentUnits::pct)) /4;
  }
  double RightVelocity(){
    return (RightWheel1.velocity(vex::percentUnits::pct)+RightWheel2.velocity(vex::percentUnits::pct))/2;
